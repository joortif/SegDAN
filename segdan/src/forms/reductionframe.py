...
class ReductionFrame(ttk.Frame):
    ...
    def __init__(self, parent, controller, config_data):
        ...
        self.row=0
        self.reduction_question_label = tk.Label(self.reduction_frame, text="Once the images have been grouped into different clusters based on their similarity, we can apply a reduction process. This process helps to simplify the dataset, making it easier to work with, especially when dealing with large amounts of data.\n\n" +
