...
class ClusteringConfigForm():
    ...
    def create_widgets(self):
        ...
        tk.Button(btn_frame, text="Save configuration", command=lambda: FormUtils.save_config(self.clustering_data)).pack(side="right", padx=5)
